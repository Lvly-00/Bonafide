...
type SurveyRole = 'parent' | 'teacher'
...
export default function AssessmentSurveyModal({ bookingId, role, onClose }: AssessmentSurveyModalProps) {
  ...
  return (
    <DialogContent onClose={onClose} className="max-w-xl max-h-[85vh] overflow-y-auto">
      <DialogHeader>
        <DialogTitle>{role === 'parent' ? 'Parent' : 'Teacher'} Session Assessment</DialogTitle>
      </DialogHeader>
